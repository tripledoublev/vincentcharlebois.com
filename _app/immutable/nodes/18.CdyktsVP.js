import{s as _,a as N,r as Y,t as F}from"../chunks/CxvfGiMk.js";import{S as X,i as O,k as S,s as I,e as h,t as w,l as J,f as V,c as C,a as y,r as M,d as f,b as A,m as B,n as R,g,h as m,u as W,o as q,p as H,q as $}from"../chunks/B9wjEPDY.js";import{g as ee,a as te}from"../chunks/CgU5AtxT.js";import{S as se}from"../chunks/DM9c3YSg.js";function oe({url:a}){return{seo:{title:"PGP Public Key Vincent Charlebois",description:"Vincent Charlebois's PGP public key for secure communication.",currentUrl:`https://www.vincentcharlebois.com${a.pathname}`}}}const fe=Object.freeze(Object.defineProperty({__proto__:null,load:oe},Symbol.toStringTag,{value:"Module"}));function ae(a){let t;return{c(){t=w("Copy to clipboard")},l(s){t=A(s,"Copy to clipboard")},m(s,o){g(s,t,o)},d(s){s&&f(t)}}}function ne(a){let t;return{c(){t=w("Copied to clipboard!")},l(s){t=A(s,"Copied to clipboard!")},m(s,o){g(s,t,o)},d(s){s&&f(t)}}}function le(a){let t,s,o,l,r,E="Save as .asc file",j,i,d,n,p,x,k,v,P,U,L;const G=[a[1]];let K={};for(let e=0;e<G.length;e+=1)K=N(K,G[e]);t=new se({props:K});function Z(e,c){return e[0]?ne:ae}let D=Z(a),u=D(a);return{c(){S(t.$$.fragment),s=I(),o=h("main"),l=h("div"),r=h("button"),r.textContent=E,j=I(),i=h("button"),u.c(),d=I(),n=h("button"),p=h("pre"),x=w("            "),k=w(a[2]),v=w(`
        `),this.h()},l(e){J(t.$$.fragment,e),s=V(e),o=C(e,"MAIN",{class:!0});var c=y(o);l=C(c,"DIV",{class:!0});var b=y(l);r=C(b,"BUTTON",{class:!0,"data-svelte-h":!0}),M(r)!=="svelte-10pnj3h"&&(r.textContent=E),j=V(b),i=C(b,"BUTTON",{class:!0});var z=y(i);u.l(z),z.forEach(f),b.forEach(f),d=V(c),n=C(c,"BUTTON",{class:!0});var T=y(n);p=C(T,"PRE",{});var Q=y(p);x=A(Q,"            "),k=A(Q,a[2]),v=A(Q,`
        `),Q.forEach(f),T.forEach(f),c.forEach(f),this.h()},h(){B(r,"class","text-sm font-medium download svelte-y1lg3f"),B(i,"class","text-sm font-medium download svelte-y1lg3f"),B(l,"class","flex flex-col flex-wrap md:flex-row mt-2 md:mt-12"),B(n,"class","text-sm font-medium mt-12"),B(o,"class","flex flex-col place-items-center justify-center min-h-[75vh]")},m(e,c){R(t,e,c),g(e,s,c),g(e,o,c),m(o,l),m(l,r),m(l,j),m(l,i),u.m(i,null),m(o,d),m(o,n),m(n,p),m(p,x),m(p,k),m(p,v),P=!0,U||(L=[W(r,"click",a[4]),W(i,"click",a[3]),W(n,"click",a[3])],U=!0)},p(e,[c]){const b=c&2?ee(G,[te(e[1])]):{};t.$set(b),D!==(D=Z(e))&&(u.d(1),u=D(e),u&&(u.c(),u.m(i,null)))},i(e){P||(q(t.$$.fragment,e),P=!0)},o(e){H(t.$$.fragment,e),P=!1},d(e){e&&(f(s),f(o)),$(t,e),u.d(),U=!1,Y(L)}}}function re(a,t,s){const o={title:"PGP Public Key | Vincent Charlebois",description:"Vincent Charlebois PGP public key for secure communication."};let l=`
...
-----END PGP PUBLIC KEY BLOCK-----
    `,r=!1;async function E(){try{await navigator.clipboard.writeText(l),s(0,r=!0),await F(),setTimeout(()=>{s(0,r=!1)},2e3)}catch{}}function j(){const i=new Blob([l],{type:"text/plain"}),d=URL.createObjectURL(i),n=document.createElement("a");n.href=d,n.download="vincent_charlebois_public_key.asc",document.body.appendChild(n),n.click(),document.body.removeChild(n),URL.revokeObjectURL(d)}return[r,o,l,E,j]}class pe extends X{constructor(t){super(),O(this,t,re,le,_,{})}}export{pe as component,fe as universal};
